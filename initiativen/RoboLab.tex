\begin{initiativkarte}{RobotLab HAW Hamburg}
  ...
  % Beschreibung
  \textbf{\textcolor{hawblue}{Was ist RobotLab?}}\\[0.3cm]

  RobotLab ist eine Forschungs- und Lernplattform, die zeigt, wie Informatik und Robotik in der Praxis zusammenwirken.
  ...
  RobotLab verbindet Forschung und Praxis und zeigt, dass Informatik nicht nur abstrakt ist, sondern direkt in realen Anwendungen sichtbar wird.
