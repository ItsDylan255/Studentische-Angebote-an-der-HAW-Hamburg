\begin{initiativkarte}{Mental Health First Aid (MHFA)}
  ...
  \begin{itemize}
    \item Du wählst eine MHFA-Person aus der Liste
    \item Du schreibst eine E-Mail mit deinem Anliegen (so viel oder wenig wie du möchtest)
    \item Ihr vereinbart ein vertrauliches Gespräch (online, in der Hochschule oder bei einem Spaziergang)
  \end{itemize}

  \vspace{0.5cm}

  MHFA ist ein niedrigschwelliges Angebot, das dir in schwierigen Situationen erste Orientierung und Unterstützung bietet.
