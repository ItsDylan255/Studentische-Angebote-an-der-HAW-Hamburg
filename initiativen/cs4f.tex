\begin{initiativkarte}{Computer Science for Future (CS4F)}
  ...
  \begin{itemize}
      ...
      \item Entwicklung nachhaltiger digitaler Lösungen
      \item Förderung interdisziplinärer Perspektiven
  \end{itemize}
  ...
  \begin{itemize}
      ...
      \item Nachhaltige Softwareentwicklung
      \item gesellschaftliche Verantwortung der Informatik
  \end{itemize}

  Zentrale Projekte sind unter anderem das Nachhaltigkeitslabor (NahLab!), das Studierenden praxisnahe Mikromodule bietet, sowie ein MS-Team zur kollaborativen Entwicklung der Initiative.

  Ergänzt wird CS4F durch einen Podcast, in dem aktuelle Themen, Forschungsideen und gesellschaftliche Fragestellungen diskutiert werden.
